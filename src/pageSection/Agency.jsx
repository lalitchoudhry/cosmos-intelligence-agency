...
const Agency = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row justify-between items-center md:items-end md:p-20 p-5 py-10">
      <div className={`flex flex-col-reverse md:flex-col justify-center items-center animate-visible ${
        ...
        <h3 className="font-bold text-3xl sm:text-5xl font-orb my-5">
          Our Intergalactic HQ
        </h3>
      </div>
      <div
        ref={ref1}
        className={`md:w-1/2 flex flex-col justify-between my-5 animate-visible ${
          isVisible1 ? "opacity-100" : "opacity-0"
        }`}
      >
        <h4 className="font-bold text-base sm:text-2xl font-mon">
          Equipping leaders with celestial wisdom, safeguarding our space-faring
          civilization from cosmic calamities!
        </h4>
        <p className="font-mon my-10 text-xl text-justify">
        ...
        <PrimaryBtn label="Discover Our Cosmic Story" href="#" />
      </div>
    </section>
  );
};
