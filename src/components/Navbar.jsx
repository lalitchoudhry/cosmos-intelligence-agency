...
const Navbar = () => {
  return (
    <header className=" fixed top-0 text-white bg-black w-full flex justify-between items-center p-5 bg-opacity-80 z-10 ">
      ...
      <nav>
        <ul className="hidden md:flex font-semibold text-xl font-comic child-hover:underline child:decoration-pink">
          <li className="mx-3">
      ...
      <div>
        <ul className="flex font-comic text-base child-hover:underline child:decoration-pink">
          <li className="mx-2 flex flex-col justify-center items-center">
            <img className="w-8 md:w-12" src={contact} alt="icon" />
            <a href="#">Alien Hotline</a>
          </li>
          <li className="mx-2 flex flex-col justify-center items-center">
            <img className="w-8 md:w-12" src={report} alt="icon" />
            <a href="#">Cosmic Intel</a>
          </li>
        </ul>
      </div>
    </header>
